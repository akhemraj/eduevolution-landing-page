        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="self-center whitespace-nowrap mt-2">
                Revolutionize the way you grade <br /> with AI Precision
              </p>
          ...
          <div className="sm:flex sm:items-center sm:justify-center">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © Copyright 2024, All rights reserved by EduEvolutionAI.
            </span>
            {/* <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="text-gray-500 hover:text-blue-600 dark:hover:text-white ms-5">
