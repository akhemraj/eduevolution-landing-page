      ...
      <div className="flex justify-center items-center h-80 w-full">
        <div className="container pl-10 pr-10 mt-5 flex justify-center space-x-4">
          <div className="w-72 h-64 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <h5 className="mb-2 mt-5 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
              Time saving for Teachers
            </h5>
            <p className="mb-3 font-normal text-sm text-gray-500 dark:text-gray-700">
          ...
          <div className="w-72 h-64 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="mb-3 font-normal text-sm text-gray-500 dark:text-gray-700">
              ...
              parents fostering collaborations in learning process.
            </p>
          </div>
        </div>
      </div>
